...
#endif
    disp_cfg.rotation.swap_xy = true;  // true or false, depending on your screen orientation
    disp_cfg.rotation.mirror_x = true; // true or false, depending on your screen orientation
    disp_cfg.rotation.mirror_y = false; // false or true, depending on your screen orientation
