...
void soft_drv_lvgl_port_init(void)
{
    ...
    disp_cfg.rotation.mirror_x = false; // true or false, depending on your screen orientation
    disp_cfg.rotation.mirror_y = true;  // false or true, depending on your screen orientation
