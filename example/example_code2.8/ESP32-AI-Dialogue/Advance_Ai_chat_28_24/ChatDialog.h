...
private:
    ...
    static const int DIALOG_WIDTH = 300;          // Dialog width
    static const int DIALOG_HEIGHT = 200;         // Dialog height
    ...
    static const int BUBBLE_CONTENT_WIDTH = 170; // Bubble content width
